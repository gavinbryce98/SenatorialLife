...
{
    public class UISwipeableView<TData,TDesc, TContext> : MonoBehaviour where TContext : class
    {
        [SerializeField]
        ...
        public void Initialize(List<TData> data, List<TDesc> description)
        {
            this.data = data;
    ...
    public class UISwipeableView<TData> : UISwipeableView<SwipeableView.TData, SwipeableViewNullContext>
    {
        public UISwipeableView()
        {
        }

        internal void Initialize(List<BasicCardData> data, List<LoadDescription> description)
        {
    ...
    public class UISwipeableView<TData, T>
    {
    }
}